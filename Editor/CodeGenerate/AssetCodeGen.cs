...
namespace FEngineEditor
{
    public class AssetCodeGen
    {
        ...
        public static void RenameAssets()
        {
            ...
            List<FFile.UnityFileInfo> infos = new List<FFile.UnityFileInfo>();
            FFile.GetAllSubUnityFileInfos(ref  infos,path);
            static void Test3(List<FFile.UnityFileInfo> unityFileInfo, int i)
            {
        ...
        public static void Testwea()
        {
            ...
            builder.AppendLine("using FEngine;");
            ...
            static void Test2(List<FFile.UnityFileInfo> unityFileInfo,  ref StringBuilder builder)
            {
                if (unityFileInfo == null) return;
            ...
            FFile.GetAllSubUnityFileInfos(ref  infos,"Assets/Resources");
            Test2(infos,ref builder);
            FFile.GetAllPaths(infos,ref paths);
            ...
            FFile.CreateScriptAndRefresh(generatepath,filename,builder.ToString());
