...
namespace FEngineEditor
{
    ...
    public class UIWindow:OdinEditorWindow
    {
        ...
        public string uiFormPath = "Assets/FEngine/Demo/Script/UI";
        ...
        public static void AddReference()
        {
            ...
            var fMonoReferenceHolder = gameObjects[0].transform.GetComponentInParent<FMonoReferenceHolder>();

            foreach (var gameObject in gameObjects)
            {
                fMonoReferenceHolder.Add(new FMonoReferenceHolder.MonoReference()
                {
                    go = gameObject,
        ...
        public void GenerateUIFormCode()
        {
            ...
            var fMonoReferenceHolder = gameObject.TryGetOrAddComponent<FMonoReferenceHolder>();
