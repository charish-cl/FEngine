...
namespace FEngineEditor
{
    ...
    public class CodeGenerateWindow:OdinEditorWindow
    {
        ...
        {
          data =  FResources.LoadAssetAtPath<FEngine.EnumGenerateData>("Assets/FEngine/Config/EnumGenerate/Enum Generate Data.asset");
        ...
        {
            var data = FResources.LoadAssetAtPath<FEngine.EnumGenerateData>("Assets/FEngine/Config/EnumGenerate/Enum Generate Data.asset");
            data.Generate();
        }
    }
}