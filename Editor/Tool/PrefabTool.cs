...
namespace FEngineEditor
{
    public class PrefabTool
    {
        ...
        {
            var gos=FResources.LoadAllFile<GameObject>(path);
        ...
        {
            var allSubFile= FFile.GetAllSubFile<GameObject>(sourcepath,patten);
        ...
        public static void BatchReplace()
        {
            ...
            Dictionary<string, GameObject> finddic = FResources.GetFindDic("t:prefab");
